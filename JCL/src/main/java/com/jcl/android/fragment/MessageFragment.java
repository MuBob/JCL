...
import com.jcl.android.activity.MessageDetilActivity;
...
public class MessageFragment extends BaseFragment implements 
	...
	public synchronized static MessageFragment getInstance() { 
        if (null == instance) { 
...
//		}
	...
	private void initView() {
		rg_tab=(RadioGroup) root.findViewById(R.id.rg_tab);
		...
		rb_unread= (RadioButton) root.findViewById(R.id.rb_unread);
		rb_isread= (RadioButton) root.findViewById(R.id.rb_isread);
		
		
		lv_message = (ListView) root.findViewById(R.id.lv_goods);
	...
	private void initNavigation() {
		...
		uINavigationView.setVisibility(View.GONE);
