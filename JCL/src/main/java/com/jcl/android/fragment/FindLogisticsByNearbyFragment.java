...
import com.jcl.android.fragment.FindLogisticsByListFragment.PageType;
import com.jcl.android.fragment.FindStoragesByNearbyFragment.FindStoragesAdapter;
import com.jcl.android.fragment.FindStoragesByNearbyFragment.GetStr;
import com.jcl.android.fragment.FindStoragesByNearbyFragment.ViewHolder;
 ...
 *
 */
public class FindLogisticsByNearbyFragment extends BaseFragment implements
		  OnClickListener {
	private View root;
...
//		srLayout.setOnLoadListener(this);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mAdapter = new FindLogisticsAdapter();
...
//							C.INTENT_TYPE_FIND_LOGISTIC,dataList.get(position).get_id()));
	...
	private void loadData() {
		...
		// 拼接filter中数据
		String filters = new Gson().toJson(new PageType(longitude,latitude));
...
//	}
	...
	class PageType {
		...
		public PageType(String longitude,String latitude) {
	...
	class FindLogisticsAdapter extends BaseAdapter {
