...
public class DetailFindLogisticFragment extends BaseFragment implements
		OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		root = inflater.inflate(R.layout.fragment_detail_find_logistic, container,
				false);
		initView();
		return root;
	}
	...
	public static DetailFindLogisticFragment newInstance(String id) {
		DetailFindLogisticFragment f = new DetailFindLogisticFragment();
						...
						if (arg0 != null) {
							if (TextUtils.equals(arg0.getCode(), "1")) {
								tv_storagename.setText(arg0.getData()
										.getZhname());
								tv_storagelinkman.setText(arg0.getData()
										.getLinkman()+" "+arg0.getData()
										.getPhone());
								tv_storageaddress.setText(arg0.getData()
										.getAddress());
								tv_storagecontent.setText(arg0.getData()
										.getContent());
								tv_chufadi.setText(arg0.getData()
										.getStartarea());
								tv_mudidi.setText(arg0.getData()
										.getEndarea());
