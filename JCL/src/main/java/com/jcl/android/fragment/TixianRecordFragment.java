 ...
 *
 */
public class TixianRecordFragment extends BaseFragment implements
	...
	public static TixianRecordFragment newInstance(int position) {
		TixianRecordFragment f = new TixianRecordFragment();
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		dataList = new ArrayList<FindTixianListBean.Applylist>();
	...
	private void loadData() {
		...
		executeRequest(new GsonRequest<FindTixianListBean>(Request.Method.POST,
				UrlCat.URL_SEARCH, FindTixianListBean.class, null,
				ParamsBuilder.pageSearchParams(getStr),
				new Listener<FindTixianListBean>() {

					@Override
					public void onResponse(FindTixianListBean arg0) {
						// 清除刷新小图标
...
//						MyToast.showToast(getActivity(), arg0.getMessage());
	...
	class FindRecordsAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.tv_time.setText(dataList.get(position).getApplytime());
