...
public class RegisterPersonalFragment extends BaseFragment implements OnClickListener{
...
private EditText edt_invitation_code;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		root = inflater.inflate(R.layout.fragment_register_personal, container,false);
		return root;
	}
	...
	private void initView()
	{
		...
		edt_invitation_code=(EditText) root.findViewById(R.id.edt_invitation_code);
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_register:
			...
			registerRequest = new RegisterData(edt_tel.getText().toString(), MD5.getMD5(edt_password.getText().toString()), 
						...
						public void onResponse(BaseBean arg0) {
							...
							if(arg0!=null){
								if ("1".equals(arg0.getCode())) {
									Toast.makeText(getActivity(), arg0.getMsg()+"请完善信息！",
											1000).show();
									getActivity().finish();
								}else{
