...
public class SettingGoodsOrderFragment extends BaseFragment implements
    ...
    private static final String TAG = "SGOFragmentTAG";
        ...
        executeRequest(new GsonRequest<FindGoodsListBean>(Request.Method.POST,
                ...
                new Listener<FindGoodsListBean>() {
                    ...
                    public void onResponse(FindGoodsListBean arg0) {
                        ...
                        Log.i(TAG, "SettingGoodsOrderFragment.onResponse: arg0=" + arg0);
                        if (arg0 != null) {
...
//						MyToast.showToast(getActivity(), arg0.getMessage());
    ...
    private List<FindGoodsListBean.Goods> getUnrealData() {
        List<FindGoodsListBean.Goods> datas = new ArrayList<>();
        FindGoodsListBean.Goods data_unreal = new FindGoodsListBean().new Goods();
        data_unreal.setStatus("4");
        data_unreal.setGoodorder("goodOrder");
        data_unreal.setStartarea("起始地点");
        data_unreal.setEndarea("结束地点");
        data_unreal.setExfhstarttime("起始时间");
        data_unreal.setExfhendtime("结束时间");
        data_unreal.setZffs("1");
        data_unreal.set_id("goodid");
        data_unreal.setLinkman("联系人");
        data_unreal.setPhone("123456789");
        data_unreal.setPrice("12.32");
        data_unreal.setGoodsweight("1");
        datas.add(data_unreal);
        return datas;
    }
    ...
    class FindGoodsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Log.i(TAG, "FindGoodsAdapter.getView: type=" + type);
            ...
            if (0 == type) {
                ...
                holder.tv_chexing.setText("车主：" + dataList.get(position).getLinkman() + " 联系电话：" + phone);
                holder.tv_chengyunprice.setText("承运价格: ￥" + price);
                    ...
                    if (dataList.get(position).getStatus() != null) {
                        switch (dataList.get(position).getStatus()) {
                            case "4":
                                ...
                                holder.tv_qiang.setOnClickListener(new QuerenfukuanOnclickListnener(goodsid, vanorderid, phone, price));
...
//			                getActivity().finish();
    ...
    public class QuerenfukuanOnclickListnener implements OnClickListener {
       ...
       private class Data {
        ...
        public void onClick(View arg0) {
            AlertDialog.Builder builder = new Builder(getActivity());
            builder.setMessage("请选择付款方式");
            builder.setTitle("消息提示!");
            builder.setCancelable(true);
            builder.setPositiveButton("线下支付", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
...
//		                getActivity().finish();
            ...
            builder.setNegativeButton("线上支付", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    dialog.dismiss();
                    alertDialog.show();
