...
public class DetailFindDistributionFragment extends BaseFragment implements
		OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		root = inflater.inflate(R.layout.fragment_detail_find_distribution, container,
				false);
		initView();
		return root;
	}
	...
	public static DetailFindDistributionFragment newInstance(String id) {
		DetailFindDistributionFragment f = new DetailFindDistributionFragment();
