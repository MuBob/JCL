 ...
 *
 */
public class SettingGoodsOrderActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(R.layout.activity_setting_goods_order);
		initNavigation();
		initView();
	}
	...
	private void initNavigation() {
		...
		//我的货源
				btnRightText.setOnClickListener(new OnClickListener() {
					...
					@Override
					public void onClick(View v) {
						startActivity(new Intent(SettingGoodsOrderActivity.this,SettingPublicGoodsActivity.class));
					}
				});
	}
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public android.support.v4.app.Fragment getItem(int position) {
			return SettingGoodsOrderFragment.newInstance(position);
		}
