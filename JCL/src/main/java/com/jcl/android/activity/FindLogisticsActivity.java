 ...
 *
 */
public class FindLogisticsActivity extends BaseActivity implements OnPageChangeListener{
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(R.layout.activity_find_logistics);
		initView();
		initNavigation();
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public android.support.v4.app.Fragment getItem(int position) {
			switch (position) {
			case 0:
				return new FindLogisticsByListFragment();
			case 1:
				return new FindLogisticsByNearbyFragment();
			case 2:
