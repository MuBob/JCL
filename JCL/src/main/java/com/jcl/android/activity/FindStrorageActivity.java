...
import com.jcl.android.activity.FindGoodsActivity.SectionsPagerAdapter;
...
import com.jcl.android.bean.FindStoragesListBean.Storage;
import com.jcl.android.fragment.FindBGoodsByListFragment;
import com.jcl.android.fragment.FindBGoodsByNearbyFragment;
import com.jcl.android.fragment.FindStoragesByListFragment;
import com.jcl.android.fragment.FindStoragesByNearbyFragment;
...
public class FindStrorageActivity extends BaseActivity implements OnPageChangeListener {
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(R.layout.activity_find_strorage);
		initView();
		initNavigation();
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public android.support.v4.app.Fragment getItem(int position) {
			switch (position) {
			case 0:
				return new FindStoragesByListFragment();
			case 1:
				return new FindStoragesByNearbyFragment();
			case 2:
