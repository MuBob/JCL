...
import com.jcl.android.fragment.SettingPublicKuaiXunFragment;
import com.jcl.android.utils.SharePerfUtil;
import com.jcl.android.view.MyUINavigationView;
import com.jcl.android.view.NoScrollViewPager;

public class SettingPublicKuaiXunActivity extends BaseActivity{
	...
	private void initNavigation() {
		...
		uINavigationView.getTv_title().setText("快讯发布");
		...
		btnRightText.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (SharePerfUtil.getLinkMan().isEmpty()) {
					...
					Toast.makeText(SettingPublicKuaiXunActivity.this,
							"请先完善信息，完善后才能发布信息", Toast.LENGTH_LONG).show();
				} else {
					
					Intent intent = new Intent(SettingPublicKuaiXunActivity.this,
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public android.support.v4.app.Fragment getItem(int position) {
			return SettingPublicKuaiXunFragment.newInstance();
		}
