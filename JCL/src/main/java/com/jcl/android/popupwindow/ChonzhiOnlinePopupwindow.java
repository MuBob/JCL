 ...
 *
 */
public class ChonzhiOnlinePopupwindow extends PopupWindow implements
		OnClickListener {
	...
	public ChonzhiOnlinePopupwindow(Context context, View parentView,
		...
		root = LayoutInflater.from(context).inflate(R.layout.popupwindow_chongzhi_online,
				null);
