...
public class PayOnlinePopupwindow extends PopupWindow implements
		OnClickListener {
	...
	public PayOnlinePopupwindow(Context context, View parentView,
		...
		root = LayoutInflater.from(context).inflate(R.layout.popupwindow_pay_online,
				null);
