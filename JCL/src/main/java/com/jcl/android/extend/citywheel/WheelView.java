...
package com.jcl.android.extend.citywheel;
...
import com.jcl.android.extend.citywheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		// TODO: make it static
		itemsLayout.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, MyApplicationUtils.DPtoPX(JCLApplication.getContext(), 50)));
